...
Recommendation System for Social Networks </h1>      
        ...
        <nav>
          <ul class="menu">
              <li><a class="active" href="userpage.jsp">HomePage</a></li>
...
%>
        ...
        <div class="wrapper">
         ...
         <table width="850" border="4" style="text-align: center;background: black">
...
String n=null, u=null,p=null,m=null,a=null,l=null,s=null,t=null;
                    ...
                    ResultSet rs = st.executeQuery("select * from regpage where userid='"+me+"' ");
                    while(rs.next()){
